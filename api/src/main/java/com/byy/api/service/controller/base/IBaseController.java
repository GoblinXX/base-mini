...
public interface IBaseController {
   ...
   * @return Class
   */
  default Class<?> getCurrentUserClass() {
   ...
   * @return ResponseObject
   */
  default <T> ResponseObject<Map<String, Object>> toPageMap(List<T> list, Long total) {
    return ResponseObject.success(MapHelper.of("list", list, "total", total));
  }
}
