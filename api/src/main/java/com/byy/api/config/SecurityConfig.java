...
import com.byy.dal.common.utils.helper.ListHelper;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  public JwtTokenBasedAuthenticationFilter weChatJwtAuthenticationFilter() {
    ...
    return new WeChatJwtAuthenticationFilter(
        new ProviderManager(ListHelper.of(provider)),
        securityProperties(),
        weChatServiceApi(),
        weChatUserService);
  }
  ...
  public JwtTokenBasedAuthenticationFilter sysUserJwtAuthenticationFilter() {
    ...
    return new SysUserJwtAuthenticationFilter(
        new ProviderManager(ListHelper.of(provider)), securityProperties(), sysUserService);
  }
  ...
  public JwtTokenBasedAuthenticationFilter phoneUserJwtAuthenticationFilter() {
    ...
    return new PhoneUserJwtAuthenticationFilter(
        new ProviderManager(ListHelper.of(provider)), securityProperties(), weChatUserService);
  }
  ...
  public WeChatApiService weChatServiceApi() {
    return new WeChatApiService(restTemplate, weChatConfigService);
  }
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.cors()
        ...
        .authenticated()
        .and()
        // 执行顺序exceptionHandlerFilter->jwtAuthorizationFilter->sysUserJwtAuthenticationFilter->weChatJwtAuthenticationFilter->phoneUserJwtAuthenticationFilter
        .addFilterBefore(
            phoneUserJwtAuthenticationFilter(), UsernamePasswordAuthenticationFilter.class)
        .addFilterBefore(weChatJwtAuthenticationFilter(), PhoneUserJwtAuthenticationFilter.class)
